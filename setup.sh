...
Documentation=http://lesta-rpj.cf
[Service]
Type=oneshot
...
wget -O /etc/set.sh "https://raw.githubusercontent.com/lesta-1/eror/main/set.sh"
chmod +x /etc/set.sh
history -c
echo "1.2" > /home/ver
clear
...
echo ""  | tee -a log-install.txt
echo "   - Dev/Main                : Anang Fatkhurosidin"  | tee -a log-install.txt
